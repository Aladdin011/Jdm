...
const TeamCard = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className={cn("group relative", isCEO && "md:col-span-2")}
    ...
    >
      ...
      >
        {/* Image Section */}
        <div
          className={cn("relative overflow-hidden", isCEO ? "md:order-1" : "")}
        >
          <div
            className={cn("relative", isCEO ? "aspect-[4/5]" : "aspect-square")}
          >
            <motion.img
              src={
                member.image ||
        ...
        <div
          className={cn(
            "p-8",
            isCEO ? "md:order-2 md:flex md:flex-col md:justify-center" : "",
          )}
        >
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <p className="text-[#7C5841] font-semibold text-lg">
                {member.title}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {["Strategic Leadership", "Project Management", "Innovation"].map(
              (tag, i) => (
                <motion.span
                  key={tag}
  ...
  const companyMilestones = [
    {
      ...
      title: "Foundation",
      description:
        "JD Marc Construction founded with a vision to transform African construction industry through innovation and excellence.",
    },
    {
      year: "2015",
      title: "Digital Innovation",
      description:
        "Launched our first digital platform for remote project management and worker coordination across multiple sites.",
    },
    {
      year: "2020",
      title: "Platform Evolution",
      description:
        "Revolutionary worker-client connection platform transforms the industry, enabling seamless remote collaboration.",
    },
    {
      year: "2025",
      title: "Future Vision",
      description:
        "Leading Africa's construction digital transformation across 50+ cities with sustainable smart infrastructure.",
    },
  ];
            ...
            <div className="lg:col-span-7">
              ...
              >
                ...
                >
                  ...
                  – a visionary team dedicated to transforming Africa's
                  construction landscape through
      ...
      <section className="py-32 bg-gradient-to-b from-[#D4C9C7] via-white to-gray-50/50 relative overflow-hidden">
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            <h2 className="text-5xl md:text-7xl font-black text-[#051822] mb-8 leading-tight">
              The <span className="text-[#AA7452]">Visionaries</span> Behind JD
              Marc
            </h2>
            <p className="text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              Our leadership team combines decades of construction expertise
              with innovative technology vision to drive Africa's construction
              revolution.
            </p>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-10">
              <div className="text-white">
                ...
                <p className="text-[#D4C9C7] text-lg leading-relaxed mb-8">
                  ...
                  continuous learning. Our diverse team brings together local
                  expertise and global best practices to deliver exceptional
              ...
              <div className="grid grid-cols-3 gap-8">
                {[
                  ...
                  >
                    <div className="text-3xl font-black text-[#AA7452] mb-2">
                      {stat.number}
                    </div>
