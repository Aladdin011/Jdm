          ...
          <div className="flex-1 p-8">
            <div className="flex items-start justify-between mb-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
              >
                <Heart className={cn("w-5 h-5", isLiked ? "text-red-500 fill-current" : "text-gray-400")} />
              </motion.button>
            </div>
            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
              <div className="text-center">
                <div className="text-2xl font-black text-[#AA7452]">{project.duration}</div>
                <div className="text-sm text-gray-600">Duration</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-black text-[#AA7452]">{project.budget}</div>
                <div className="text-sm text-gray-600">Investment</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-black text-[#AA7452]">{project.teamSize}</div>
        ...
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <div className="absolute top-4 right-4 flex gap-2">
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
            >
              <Heart className={cn("w-4 h-4", isLiked ? "text-red-400 fill-current" : "text-white")} />
            </motion.button>
            <motion.button
              onClick={() => onView(project)}
              className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/30 transition-all duration-300"
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div className="text-center p-3 bg-gradient-to-r from-[#AA7452]/5 to-[#7C5841]/5 rounded-xl">
              <div className="text-lg font-black text-[#AA7452]">{project.budget}</div>
              <div className="text-xs text-gray-600">Investment</div>
            </div>
            <div className="text-center p-3 bg-gradient-to-r from-[#051822]/5 to-[#2D383E]/5 rounded-xl">
              <div className="text-lg font-black text-[#051822]">{project.teamSize}</div>
          ...
          >
            <div className="h-full flex flex-col">
              ...
              <div className="flex items-center justify-between p-6 border-b border-gray-200">
                <div>
                  <h2 className="text-2xl font-black text-[#051822]">{project.title}</h2>
                    ...
                    <div className="mb-8">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="text-center p-4 bg-gradient-to-r from-[#AA7452]/10 to-[#7C5841]/10 rounded-2xl">
                          ...
                          <div className="text-lg font-black text-[#051822]">{project.duration}</div>
                          <div className="text-sm text-gray-600">Duration</div>
                        </div>
                        ...
                        <div className="text-center p-4 bg-gradient-to-r from-[#7C5841]/10 to-[#AA7452]/10 rounded-2xl">
                          ...
                          <div className="text-lg font-black text-[#051822]">{project.budget}</div>
                          <div className="text-sm text-gray-600">Investment</div>
                        </div>
                      ...
                      {/* Technologies used */}
                      <div className="mb-6">
                        <h4 className="font-bold text-[#051822] mb-3">Technologies & Methods</h4>
                        <div className="flex flex-wrap gap-2">
                      ...
                      {project.features && (
                        <div>
                          <h4 className="font-bold text-[#051822] mb-3">Key Features</h4>
        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-6 text-center">
            ...
            >
              ...
              >
                Explore our collection of <span className="text-[#AA7452] font-semibold">premium construction projects</span> 
                across Africa and beyond, showcasing innovation, quality, and 
                <span className="text-[#D4C9C7] font-semibold"> sustainable development</span>.
              </motion.p>
          ...
          <div className="container mx-auto px-6 relative z-10">
            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-3">
                {["all", ...projectCategories.map(cat => cat.slug)].map((category) => (
                  <motion.button
                    key={category}
            ...
            {filteredProjects.length === 0 && (
              ...
              >
                ...
                <p className="text-gray-600 max-w-md mx-auto">
                  Try adjusting your search criteria or browse all projects to discover our work.
                </p>
              </motion.div>
            )}
          </div>
