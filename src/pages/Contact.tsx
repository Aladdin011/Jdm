            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="flex items-center gap-4 p-3 hover:bg-gray-50 rounded-xl transition-colors">
                ...
                <div>
                  ...
                  <div className="font-medium text-[#051822]">
                    {office.hours}
                  </div>
                </div>
              </div>
    ...
    return (
      ...
      >
        ...
        <p className="text-green-700 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
          Thank you for contacting JD Marc. Our construction experts will review
          your project details and get back to you within 24 hours with a
    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h3 className="text-2xl font-black text-[#051822]">
            Contact Information
          </h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            >
              <Label
                htmlFor={field.id}
                className="text-[#051822] font-semibold"
              >
                {field.label}{" "}
      ...
      >
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h4 className="text-xl font-black text-[#051822]">
              Project Documents
            </h4>
            <p className="text-gray-600 text-sm">
              Upload sketches, blueprints, or specifications (Optional)
            </p>
          </div>
        </div>
...
export default function Contact() {
  ...
  return (
    <Layout>
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          >
            ...
            >
              ...
              together? Connect with JD Marc across our global offices and
              discover how we can
              ...
              {[
                {
                  icon: Phone,
                  title: "Call Us",
                  desc: "+234 803 706 5497",
                  action: "tel:+2348037065497",
                },
                {
                  icon: Mail,
                  title: "Email Us",
                  desc: "info@jdmarcng.com",
                  action: "mailto:info@jdmarcng.com",
                },
                {
                  icon: MessageSquare,
                  title: "Chat Support",
      ...
      <section
        id="form"
        className="py-32 bg-gradient-to-b from-gray-50/50 via-white to-[#D4C9C7]/5 relative overflow-hidden"
      >
        <div className="container mx-auto px-6 relative z-10">
          <motion.div
            initial={{ opacity: 0, y: 50 }}
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Share your construction or infrastructure project details. Our
              expert team will provide a personalized consultation within 24
              hours.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Located in the heart of Abuja, our headquarters serves as the
              central hub for all African operations and project management.
            </p>
          </motion.div>
