            ...
            <CardContent className="p-6">
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="general" className="space-y-6 mt-6">
                  <div>
                    <h3 className="text-lg font-semibold text-[#142E54] mb-4">General Configuration</h3>
                ...
                <TabsContent value="notifications" className="space-y-6 mt-6">
                  <div>
                    <h3 className="text-lg font-semibold text-[#142E54] mb-4">Notification Preferences</h3>
                    <div className="space-y-4">
                      {Object.entries(settings.notifications).map(([key, value]) => (
                        <div key={key} className="flex items-center justify-between p-4 border rounded-lg">
                          <div className="flex items-center gap-3">
                            {key === 'emailNotifications' && <Mail className="h-5 w-5 text-[#A7967E]" />}
                            {key === 'pushNotifications' && <Bell className="h-5 w-5 text-[#A7967E]" />}
                            {key === 'smsNotifications' && <Smartphone className="h-5 w-5 text-[#A7967E]" />}
                            {key === 'weeklyReports' && <Clock className="h-5 w-5 text-[#A7967E]" />}
                            {key === 'systemAlerts' && <AlertTriangle className="h-5 w-5 text-[#A7967E]" />}
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                ...
                                {key === 'systemAlerts' && 'Critical system alerts'}
                              </p>
                            </div>
                          </div>
                          <Switch
                ...
                <TabsContent value="security" className="space-y-6 mt-6">
                  <div>
                    <h3 className="text-lg font-semibold text-[#142E54] mb-4">Security Configuration</h3>
                    <div className="space-y-6">
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-3">
                          <Lock className="h-5 w-5 text-[#A7967E]" />
                          <div>
                            <p className="font-medium text-[#142E54]">Two-Factor Authentication</p>
                ...
                <TabsContent value="backup" className="space-y-6 mt-6">
                  <div>
                    <h3 className="text-lg font-semibold text-[#142E54] mb-4">Backup Configuration</h3>
                    <div className="space-y-6">
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-3">
                          <Database className="h-5 w-5 text-[#A7967E]" />
                          <div>
                            <p className="font-medium text-[#142E54]">Automatic Backup</p>
                ...
                <TabsContent value="integrations" className="space-y-6 mt-6">
                  <div>
                    <h3 className="text-lg font-semibold text-[#142E54] mb-4">Third-party Integrations</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
