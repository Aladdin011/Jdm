...
export const useDashboardActions = (componentName: string) => {
  ...
  const executeAction = useCallback(
    async (
      ...
      try {
        ...
        logDashboardAction(componentName, actionName, true, undefined, {
          result,
        });
        return result;
      } catch (error) {
  ...
  const updateProject = useCallback(
    async (projectId: string, projectData: any) => {
      return executeAction(
        "updateProject",
  ...
  const updateTask = useCallback(
    async (taskId: string, taskData: any) => {
      return executeAction(
        "updateTask",
        async () => {
          // Mock implementation - replace with actual API
  ...
  const approveLeave = useCallback(
    async (leaveId: string, employeeName: string) => {
      return executeAction(
        "approveLeave",
        async () => {
          // Mock implementation - replace with actual API
  ...
  const exportData = useCallback(
    async (dataType: string, format: string) => {
      return executeAction(
        "exportData",
        async () => {
          // Mock implementation - replace with actual API
