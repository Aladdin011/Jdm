...
const testimonials: Testimonial[] = [
  {
    ...
    rating: 5,
    quote: "JD Marc's platform revolutionized how we manage our construction projects. We connected with skilled professionals across Lagos and completed our 20-unit residential complex 3 months ahead of schedule. The remote collaboration tools made communication seamless.",
    project: {
  ...
  },
  {
    ...
    rating: 5,
    quote: "The platform opened up opportunities I never had before. I've worked on projects across three states without leaving my home base in Abuja. The quality of clients and projects has been exceptional, and the payment system gives me complete confidence.",
    achievements: {
      projects: 25,
      value: '₦50M',
      rating: 4.9
  ...
  },
  {
    ...
    rating: 5,
    quote: "What started as a single project connection has become a long-term partnership. The platform's matching system paired us perfectly - Tunde's expertise in sustainable construction was exactly what our eco-friendly resort project needed.",
    partnership: {
      projects: 5,
      results: [
        { icon: <Building2 className="w-4 h-4" />, text: '5 Projects Completed' },
        { icon: <Heart className="w-4 h-4" />, text: '100% Sustainable Materials' },
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden max-w-4xl mx-auto">
        ...
        <div className={`p-8 bg-gradient-to-br ${
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="relative">
              ...
              <div className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-full flex items-center justify-center text-white shadow-lg ${
                testimonial.type === 'client' 
                  ? 'bg-blue-500' 
                  : testimonial.type === 'worker' 
                  ? 'bg-green-500'
                ...
                {testimonial.type === 'client' ? <Building2 className="w-4 h-4" /> :
                 testimonial.type === 'worker' ? <Users className="w-4 h-4" /> :
            ...
            <div className={`px-4 py-2 rounded-full text-sm font-medium ${
              ...
              {testimonial.type === 'client' ? 'Client Story' :
               testimonial.type === 'worker' ? 'Worker Success' :
               'Partnership'}
            </div>
          </div>
        </div>
        ...
        <div className="px-8 pb-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h5 className="font-medium text-gray-900">{testimonial.project.name}</h5>
                  <div className="grid grid-cols-3 gap-3">
                    {testimonial.project.stats.map((stat, index) => (
                      <div key={index} className="text-center p-3 bg-white rounded-lg">
                        <div className="text-lg font-bold text-[#AA7452]">{stat.value}</div>
          ...
          {testimonial.type === 'worker' && testimonial.achievements && (
            <div className="bg-gray-50 rounded-2xl p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Achievement Overview</h4>
              <div className="grid grid-cols-3 gap-4">
                <div className="text-center p-4 bg-white rounded-lg">
                  <div className="text-2xl font-bold text-[#AA7452] mb-1">{testimonial.achievements.projects}</div>
                  <div className="text-sm text-gray-600">Projects Completed</div>
                </div>
                <div className="text-center p-4 bg-white rounded-lg">
                  <div className="text-2xl font-bold text-[#AA7452] mb-1">{testimonial.achievements.value}</div>
                  <div className="text-sm text-gray-600">Total Project Value</div>
                </div>
                <div className="text-center p-4 bg-white rounded-lg">
                  <div className="text-2xl font-bold text-[#AA7452] mb-1">{testimonial.achievements.rating}</div>
          ...
          {testimonial.type === 'collaboration' && testimonial.partnership && (
            <div className="bg-gray-50 rounded-2xl p-6">
              <h4 className="text-lg font-semibold text-gray-900 mb-4">Partnership Results</h4>
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-gradient-to-br from-gray-50 to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          {[
            { icon: CheckCircle, number: "98.5%", label: "Project Success Rate" },
