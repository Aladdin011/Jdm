    ...
    return (
      ...
      >
        ...
        <p className="text-green-700 text-sm">
          Thank you for joining our newsletter. You'll receive updates about our
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <p className="text-white/70 text-sm">
        Join 5,000+ construction professionals who trust our insights. No spam,
        unsubscribe anytime.
      </p>
    </form>
  );
            ...
            <div className="flex items-center justify-center gap-4 mb-6">
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://cdn.builder.io/api/v1/image/assets%2F751ea84be0da437c8dd3f1bf04173189%2F8c27ff3f82824383bd700bc3410cfa09?format=webp&width=200";
                  }}
                />
              </motion.div>
              <div>
                ...
                <p className="text-[#AA7452] font-semibold">
                  Building Africa's Future
                </p>
              </div>
            </div>
            <p className="text-white/80 text-lg max-w-3xl mx-auto leading-relaxed">
              Since 2007, we've been at the forefront of African construction
              and infrastructure development, delivering innovative solutions
              that transform communities and drive economic growth across the
              continent.
            </p>
          </motion.div>
