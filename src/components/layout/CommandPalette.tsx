      ...
      <Command>
        ...
        <CommandList>
          ...
          <CommandGroup heading="Navigation">
            ...
            <CommandItem onSelect={() => navigate("/security")}>
              {" "}
              <Shield className="mr-2 h-4 w-4" /> Security Center
            </CommandItem>
          ...
          <CommandGroup heading="Users">
            {filteredUsers.map((u) => (
              <CommandItem
                key={u.id}
                onSelect={() =>
                  navigate(`/users?query=${encodeURIComponent(u.email)}`)
                }
              >
                <Users className="mr-2 h-4 w-4" /> {u.firstName} {u.lastName} –{" "}
                {u.email}
              </CommandItem>
            ))}
          </CommandGroup>
