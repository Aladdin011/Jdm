...
export const setImageDimensions = (img: HTMLImageElement, width: number, height: number) => {
...
export const initLayoutStability = () => {
  try {
    stabilizeLayout();
    optimizeFontLoading();
    ...
    console.log('Layout stability optimizations initialized');
  } catch (error) {
